...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-01/src/main.rs:2}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-02/src/main.rs:2}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-03/src/main.rs:2:7}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-04/src/main.rs:2:7}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-05/src/main.rs:2:10}}
```
...
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-06/src/main.rs:2:5}}
```
...
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-07/src/main.rs:2:8}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-08/src/main.rs:2:5}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-09/src/main.rs:2:5}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-10/src/main.rs:2:12}}
```
