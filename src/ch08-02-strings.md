...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-11/src/main.rs:2}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-12/src/main.rs:2:7}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-13/src/main.rs:2}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-14/src/main.rs:2:12}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-15/src/main.rs:2:3}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-16/src/main.rs:2:5}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-17/src/main.rs:2:3}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-18/src/main.rs:2:4}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/no-listing-01-concat-multiple-strings/src/main.rs:2:6}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/no-listing-02-format/src/main.rs:2:6}}
```
...
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-19/src/main.rs:2:3}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-14/src/main.rs:12}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-14/src/main.rs:11}}
```
