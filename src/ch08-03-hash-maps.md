...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-20/src/main.rs:2:7}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-21/src/main.rs:2:7}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-22/src/main.rs:2:10}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-23/src/main.rs:2:10}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/no-listing-03-iterate-over-hashmap/src/main.rs:2:11}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-24/src/main.rs:2:9}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-25/src/main.rs:2:10}}
```
...
```rust
{{#rustdoc_include ../listings/ch08-common-collections/listing-08-26/src/main.rs:2:13}}
```
