...
```rust
{{#rustdoc_include ../listings/ch12-an-io-project/listing-12-15/src/lib.rs:28:45}}
```
...
```rust
{{#rustdoc_include ../listings/ch12-an-io-project/listing-12-16/src/lib.rs:28:30}}
```
...
```rust,ignore
{{#rustdoc_include ../listings/ch12-an-io-project/listing-12-17/src/lib.rs:28:32}}
```
...
```rust,ignore
{{#rustdoc_include ../listings/ch12-an-io-project/listing-12-18/src/lib.rs:28:34}}
```
...
```rust,ignore
{{#rustdoc_include ../listings/ch12-an-io-project/listing-12-19/src/lib.rs:28:38}}
```
...
```rust,ignore
{{#rustdoc_include ../listings/ch12-an-io-project/no-listing-02-using-search-in-run/src/lib.rs:22:30}}
```
