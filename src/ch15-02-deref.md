...
```rust
{{#rustdoc_include ../listings/ch15-smart-pointers/listing-15-08/src/main.rs:1:7}}
```
...
{{#rustdoc_include ../listings/ch15-smart-pointers/listing-15-09/src/main.rs:9:15}}
```
...
```rust
{{#rustdoc_include ../listings/ch15-smart-pointers/listing-15-10/src/main.rs:1:9}}
```
...
```rust
{{#rustdoc_include ../listings/ch15-smart-pointers/listing-15-11/src/main.rs:1:3}}
```
...
```rust
{{#rustdoc_include ../listings/ch15-smart-pointers/listing-15-12/src/main.rs:23:26}}
```
