...
```rust
{{#rustdoc_include ../listings/ch17-oop/listing-17-04/src/lib.rs:5:7}}
```
...
```rust
{{#rustdoc_include ../listings/ch17-oop/listing-17-05/src/lib.rs:9:15}}
```
...
```rust
{{#rustdoc_include ../listings/ch17-oop/listing-17-06/src/lib.rs:5:16}}
```
...
```rust
{{#rustdoc_include ../listings/ch17-oop/listing-17-07/src/lib.rs:17:27}}
```
...
```rust,ignore
{{#rustdoc_include ../listings/ch17-oop/listing-17-08/src/main.rs:1:13}}
```
...
```rust,ignore
{{#rustdoc_include ../listings/ch17-oop/listing-17-09/src/main.rs:15:38}}
```
