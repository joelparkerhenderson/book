...
```rust
{{#rustdoc_include ../listings/ch18-patterns-and-matching/listing-18-02/src/main.rs:2:10}}
```
...
```rust
{{#rustdoc_include ../listings/ch18-patterns-and-matching/listing-18-03/src/main.rs:2:6}}
```
...
```rust
{{#rustdoc_include ../listings/ch18-patterns-and-matching/listing-18-04/src/main.rs:2}}
```
...
{{#rustdoc_include ../listings/ch18-patterns-and-matching/listing-18-05/src/main.rs:2}}
```
...
```rust
{{#rustdoc_include ../listings/ch18-patterns-and-matching/listing-18-06/src/main.rs:1:3}}
```
