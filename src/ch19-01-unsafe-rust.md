...
```rust
{{#rustdoc_include ../listings/ch19-advanced-features/listing-19-01/src/main.rs:2:5}}
```
...
```rust
{{#rustdoc_include ../listings/ch19-advanced-features/listing-19-02/src/main.rs:2:3}}
```
...
```rust,unsafe
{{#rustdoc_include ../listings/ch19-advanced-features/listing-19-03/src/main.rs:2:10}}
```
...
```rust,unsafe
{{#rustdoc_include ../listings/ch19-advanced-features/no-listing-01-unsafe-fn/src/main.rs:2:6}}
```
...
```rust
{{#rustdoc_include ../listings/ch19-advanced-features/listing-19-04/src/main.rs:2:9}}
```
...
{{#rustdoc_include ../listings/ch19-advanced-features/listing-19-05/src/main.rs:1:8}}
```
...
```rust,unsafe
{{#rustdoc_include ../listings/ch19-advanced-features/listing-19-06/src/main.rs:1:13}}
```
...
```rust,unsafe
{{#rustdoc_include ../listings/ch19-advanced-features/listing-19-07/src/main.rs:2:9}}
```
